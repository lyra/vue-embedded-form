<template lang="pug">
    .container
        .row
            .col-12
                h4 Select the delivery method
                select(v-model="delivery")
                    option(value="UPS") UPS
                    option(value="Seur") Seur
                h4 Proceed with the payment
                .wrapper
                    lyra-form(
                        ...
                        .kr-expiry
                        .kr-security-code
                        button.btn.btn-primary.kr-payment-button
                        .kr-form-error
</template>
<script>
...
export default {
    ...
    watch: {
        delivery: function(newVal, oldValue) {
            if (newVal) {
                this.showForm();
            }
        }
